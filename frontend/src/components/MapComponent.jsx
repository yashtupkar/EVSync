  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-[#f8fafc]">
      ...
      {hoveredStation && (
        ...
        >
          <div className="overflow-hidden bg-white rounded-2xl shadow-2xl flex flex-col group">
          ...
          <Marker
            ...
            eventHandlers={{
              mouseover: (e) => {
                ...
                // Smart X: flip left if not enough room on the right
                let x = point.x - cardW / 2;
                if (x + cardW > containerRect.width - MARGIN) x = containerRect.width - cardW - MARGIN;
                if (x < MARGIN) x = MARGIN;

                // Smart Y: show above marker; flip below if not enough room on top
                let y = point.y - cardH - 50; // 50 = marker height + gap
                if (y < MARGIN) y = point.y + 16; // show below instead
            ...
            {showRoute ? (
                ...
                {isLoadingRoute ? (
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="p-4 flex items-center gap-4">
                      {/* Direction Icon */}
                      <div className="w-12 h-12 bg-[#1BAC4B]/10 rounded-t-2xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="relative pointer-events-auto">
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <div className="absolute bottom-full left-0 mx-6 right-0 mb-4 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
                    <div className="p-3">
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-t-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-white p-2 transition-all duration-500">
