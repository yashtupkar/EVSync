    ...
    <nav className="w-full px-10 py-4  flex items-center justify-between
     gap-10 shadow-[0_15px_40px_rgba(0,0,0,0.06)] bg-white/80 backdrop-blur-xl border border-white/50 animate-in slide-in-from-top-4 duration-700">
      ...
      <div className="flex items-center gap-8">
        <Link
          to="/"
          className={`flex items-center gap-2.5 text-[11px] font-black uppercase tracking-[0.15em] transition-all hover:scale-105 active:scale-95 ${location.pathname === "/" ? "text-[#1BAC4B]" : "text-gray-400 hover:text-gray-600"}`}
        >
