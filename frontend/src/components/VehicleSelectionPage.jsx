              ...
              <>
                ...
                <div className="space-y-4 mb-10">
                  {user?.vehicles?.map((v, index) => {
                    ...
                    return (
                      <div key={index} className="bg-white border-2 border-slate-100 rounded-2xl p-4 flex items-center gap-6 shadow-sm hover:border-[#1BAC4B]/30 transition-all">
                        ...
                        <CheckCircle2 className="text-[#1BAC4B]" size={24} />
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 py-4 border-2 border-dashed border-slate-200 text-slate-500 rounded-2xl font-bold hover:border-[#1BAC4B] hover:text-[#1BAC4B] transition-all bg-slate-50/50"
                  >
                    <Plus size={20} />
                    Add More Vehicles
                  </button>
                  <button 
                    onClick={() => navigate("/")}
                    className="w-full flex items-center justify-center gap-2 py-4 bg-[#1BAC4B] text-white rounded-2xl font-bold text-lg hover:bg-[#189a43] transition-all shadow-lg shadow-green-100"
                  >
